...
anim = FuncAnimation(fig, atualizar_grafico, interval=100, blit=False)
anim.event_source.stop()  # Para iniciar a animação apenas quando a gravação começar
...
# Inicializa o loop de coleta de dados
root.after(100, receber_dados)  # Inicia a coleta de dados a cada 100ms
